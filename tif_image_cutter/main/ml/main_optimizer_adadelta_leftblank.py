...
if __name__ == "__main__":
    model_name = "model_optimizer_adadelta_leftblank"
    u = unet.Unet()
    ...
    # w dokumentacji kerasa- pozostawić parametry
    model.compile(optimizer=Adadelta(), loss='binary_crossentropy', metrics=[u.dice_coef])
